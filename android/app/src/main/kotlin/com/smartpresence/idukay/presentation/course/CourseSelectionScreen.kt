...
fun CourseSelectionScreen(
    ...
    val courses = listOf(
        Course("a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d", "Matematicas 10A", "MAT-10A", "2024-1"),
        Course("b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e", "Fisica 11B", "FIS-11B", "2024-1"),
        Course("c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f", "Quimica 9C", "QUI-9C", "2024-1")
    )
